...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ОбработчикиСобытийЧитаемИзФайлаПравилОбмена Тогда
		Заголовок = НСтр("ru = 'Настройка отладки обработчиков при выгрузке данных'; uk = 'Налаштування налагодження обробників при вивантаженні даних'");
		ЗаголовокКнопки = НСтр("ru = 'Сформировать модуль отладки выгрузки'; uk = 'Сформувати модуль налагодження вивантаження'");
	Иначе
		Заголовок = НСтр("ru = 'Настройка отладки обработчиков при загрузке данных'; uk = 'Налаштування налагодження обробників при завантаженні даних'");
		ЗаголовокКнопки = НСтр("ru = 'Сформировать модуль отладки загрузки'; uk = 'Сформувати модуль налагодження завантаження'");
	КонецЕсли;		
